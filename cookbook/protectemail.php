<?php if (!defined('PmWiki')) exit();
                                                                    /*
  * Copyright *
      Edited 2024 by anonymous to make it compatible with php 8.1.
...
## [[mailto:target | text]]
Markup('protectedmailto|','<links',
  "/\\[\\[mailto:([^\\s$UrlExcludeChars]*)\\s*\\|\\s*(.*?)\\s*\\]\\]($SuffixPattern)/",
    "protectEmail121");
...
///new php cant do /e in Markup rules, hence new function to workaround that
//----------------------------------------------------------------------
function protectEmail1x0 ($m) {
//----------------------------------------------------------------------
